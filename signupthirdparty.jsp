<%-- 
    Document   : signupthirdparty.jsp
    Created on : 12 Apr, 2018, 6:56:06 PM
    Author     : Chinmayi
--%>
...
con=dbc.getDbConnection();
	...
	PreparedStatement ps=con.prepareStatement("insert into thirdparty(orgname,name,userid,password,legaldoc)values(?,?,?,?,?)");
...
<div class="a">
	...
	<button onclick="document.getElementById('id01').style.display='block'" class="addstud"><b>SignUp</b></button>
</div>
		<div class="content">
		<div class="topnav">
...
<td>
       <tr>
            <td><b>Organization Name:</b> </td><td><input type="text" name="orgname" placeholder="Organization Name"></td>
        </tr>

        <tr>
            <td><b>Name:</b> </td><td><input type="text" name="name" placeholder="Name"></td>
        </tr>
      
		  <tr>
            <td><b>UserId:</b> </td> <td><input type="text" name="userid" placeholder="User Id"></td>
        </tr> 
  ...
  <tr><td>
     ...
     <input type="submit"  name="signup" value="Signup"  onclick ="return validate();">
	</td></tr>     
</div>
